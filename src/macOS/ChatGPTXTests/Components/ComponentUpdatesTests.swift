...
final class ComponentUpdatesTests: XCTestCase {
        ...
        async throws
    {
        ...
        guard case let .installed(prepared) = outcome.result else {
        ...
        async throws
    {
        ...
        } catch let ComponentUpdateError.bindingUnavailable(version) {
    ...
    func testStaleUpdaterCannotReplaceNewerActiveGeneration() async throws {
        ...
        } catch let ComponentUpdateError.olderGeneration(
            remote,
            installed
        ) {
    ...
    func testExactBuildHashAndMinimumLauncherAreRequired() async throws {
        ...
        } catch let ComponentUpdateError.bindingBuildUnavailable(version) {
        ...
        } catch let ComponentUpdateError.launcherTooOld(
            installed,
            minimum
        ) {
    ...
    private func makeService(
        ...
        return try ComponentUpdateService(
