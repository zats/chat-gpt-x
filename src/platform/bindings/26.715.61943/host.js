/**
 * Renderer binding for ChatGPT 26.715.61943.
 *
...
(() => {
  ...
  const CORE_MODULE =
    "./assets/app-initial~avatarOverlayCompositionSurface~index-9fQ9wihu~index-BFCcxPM5~mapbox-gl-DVWlwqb~kppdhley-cTPFNKbJ.js";
  const MENU_MODULE =
    "./assets/app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~appgen-settings-p~evbmo86c-DGrUMXQv.js";
  const ICON_MODULE =
    "./assets/app-initial~avatarOverlayCompositionSurface~artifact-tab-content.electron~notebook-preview-~dg0b1kws-C-xpDjxf.js";
