/**
 * Renderer binding for ChatGPT 26.721.41059.
 *
...
(() => {
  ...
  const APP_INITIAL_MODULE = "./assets/app-initial-BHB6SClA.js";
  const PLUS_ICON_MODULE = "./assets/plus-BgCJgEEs-Cpm5qMw9.js";
  const PALETTE_ICON_MODULE = "./assets/palette-lzFbWMQk-WKeaD-Me.js";
  const THREAD_MENU_MODULE = "./assets/thread-overflow-menu-CHu-muVE.js";
  const AUTH_MODULE = "./assets/chatgpt-desktop-auth-url-BRuffm-N.js";
...
`;
  ...
  async function installNativeBinding() {
    ...
    appInitialModule.JB();
    appInitialModule.c_();
    appInitialModule.Klt();
    appInitialModule.xH();
    appInitialModule.To();
    appInitialModule.NX();
    appInitialModule.rdt();
    plusIconModule.t();
    paletteIconModule.n();
    threadMenuModule.n();
    const jsxRuntime = appInitialModule.Dvt();
    ...
    native = {
      React: appInitialModule.Nvt(),
      ReactDOM: appInitialModule.ept(),
      jsxRuntime,
      jsx: jsxRuntime.jsx,
      Item: appInitialModule.GB,
      Separator: appInitialModule.qB,
      SubmenuItem: appInitialModule.UB,
      FlyoutSubmenuItem: appInitialModule.WB.FlyoutSubmenuItem,
      MenuRoot: appInitialModule.HB,
      ThreadMenu: threadMenuModule.t,
      ColorPicker: appInitialModule.wo,
      startChatGptSignIn: authModule.o,
      decorateAuthUrl: authModule.t,
      useUpdateAuthNonce: appInitialModule.IX,
      useAppServerRegistry: appInitialModule.WX,
      useQueryClient: appInitialModule.Evt,
      accountInfoQueryKey: appInitialModule.Jut,
      messageBus: appInitialModule.idt,
      openInBrowser: appInitialModule.Ztt,
      useNavigate: appInitialModule.R5,
      iconComponents: new Map([
        ["chevron-right", appInitialModule.Glt],
