/**
 * Renderer binding for ChatGPT 26.831.11858.
 *
...
(() => {
  ...
  const APP_INITIAL_MODULE = "./assets/app-initial-4c1cf5f55a04.js";
  const APP_PRIMARY_MODULE = "./assets/app-primary-92136de0cef5.js";
  const PLUS_ICON_MODULE = "./assets/plus-BgCJgEEs-c2c78c61c8c7.js";
  const PALETTE_ICON_MODULE = "./assets/palette-lzFbWMQk-c51b140002bd.js";
  const THREAD_MENU_MODULE = "./assets/thread-overflow-menu-ebc8d2a9489a.js";
  const AUTH_MODULE = "./assets/chatgpt-desktop-auth-url-821278bed22b.js";
  const SETTINGS_VISIBILITY_MODULE =
    "./assets/use-visible-settings-sections-2d675a4e725c.js";
  const SETTINGS_LOADING_MODULE =
    "./assets/settings-loading-row-1cc143023ebb.js";
  const TOOLBAR_BREADCRUMB_MODULE =
    "./assets/toolbar-breadcrumb-aa4051bb20df.js";
  const CHEVRON_ICON_MODULE =
    "./assets/chevron-right-COkuMB7M-dc145b8e4a41.js";
  const USER_ICON_MODULE = "./assets/user-DzSXx5EY-3713d8880c8b.js";
  const SETTINGS_ICON_MODULE = "./assets/settings-8KXOPtTT-1eb441324709.js";
...
html[data-cgptx-header-background-color] header[data-pip-obstacle="app-shell-header"] > [data-test-id="header-shell-slot"],
html[data-cgptx-header-background-color] header[data-pip-obstacle="app-shell-header"] > [data-testid="app-shell-header-context-menu-surface"] {
...
`;
  ...
  function positionAssistantSelectionBelowSurface(element, position) {
    ...
    const boundsLeft =
      portalRect == null
        ? position.selection.viewportHorizontalBounds.left
        : portalRect.left +
          position.selection.viewportHorizontalBounds.left * info.windowZoom;
    const boundsRight =
      portalRect == null
        ? position.selection.viewportHorizontalBounds.right
        : portalRect.left +
          position.selection.viewportHorizontalBounds.right * info.windowZoom;
  ...
  async function installNativeBinding() {
    const [
      ...
      import(CHEVRON_ICON_MODULE),
      import(USER_ICON_MODULE),
      import(SETTINGS_ICON_MODULE),
    ]);
    authModule.i();
    authModule.r();
    appInitialModule.Can();
    appInitialModule.hw();
    appInitialModule.TU();
    appInitialModule.yU();
    appInitialModule.bYt();
    appInitialModule.Rpt();
    appInitialModule.xYt();
    appInitialModule.qXt();
    appInitialModule.VXt();
    appInitialModule.Nin();
    appInitialModule.iS();
    appInitialModule.Kx();
    appInitialModule.Mu();
    appInitialModule.Su();
    ...
    chevronIconModule.n();
    userIconModule.t();
    settingsIconModule.n();
    const jsxRuntime = appInitialModule.San();
    ...
    native = {
      React: appInitialModule.Can(),
      ReactDOM: appInitialModule.yan(),
      jsxRuntime,
      jsx: jsxRuntime.jsx,
      Item: appInitialModule.SU.Item,
      Separator: appInitialModule.SU.Separator,
      SubmenuItem: appInitialModule.SU.SubmenuItem,
      FlyoutSubmenuItem: appInitialModule.SU.FlyoutSubmenuItem,
      MenuRoot: appInitialModule.bU,
      SelectedTextOverlay: appPrimaryModule.po,
      SelectedTextPositioner: appPrimaryModule.ho,
      ThreadMenuAdapter: appInitialModule.vU,
      ThreadMenu: threadMenuModule.t,
      ColorPicker: appPrimaryModule.Kw,
      startChatGptSignIn: authModule.o,
      decorateAuthUrl: authModule.t,
      useAppServerRegistry: appInitialModule.Vpt,
      useQueryClient: appInitialModule.BYt,
      accountInfoQueryKey: appInitialModule.HRt,
      messageBus: appInitialModule.JXt,
      openInBrowser: appInitialModule.UXt,
      useNavigate: appInitialModule.AHt,
      useIntl: appInitialModule.Pin,
      useScope: appInitialModule.UYt,
      ApplicationScope: appInitialModule.yYt,
      SettingsPage: appInitialModule.$x,
      SettingsSectionTitle: appInitialModule.Gx,
      SettingsLoading: settingsLoadingModule.t,
      SettingsGroup: appInitialModule.ju,
      SettingsRows: appInitialModule.xu,
      SettingsRow: appInitialModule.Du,
      SettingsToggle: appInitialModule.EU,
      SettingsSelectTrigger: appInitialModule.Ux,
      SettingsButton: appInitialModule.vTt,
      SettingsTextField: appInitialModule.ZV,
      ChevronRight: chevronIconModule.t,
      ToolbarBreadcrumb: toolbarBreadcrumbModule.t,
      settingsSectionIcons: settingsVisibilityModule.i,
      iconComponents: new Map([
        ["chevron-right", chevronIconModule.t],
        ["person", userIconModule.n],
        ["plus", PlusIcon],
        ["palette", paletteIconModule.t],
        ["settings", settingsIconModule.t],
      ]),
    };
    openNativeSettings = () => {
