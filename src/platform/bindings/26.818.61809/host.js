/**
 * Renderer binding for ChatGPT 26.818.61809.
 *
...
(() => {
  ...
  const APP_INITIAL_MODULE = "./assets/app-initial-q5My48Y-.js";
  const PLUS_ICON_MODULE = "./assets/plus-BgCJgEEs-C_-OO9VZ.js";
  const PALETTE_ICON_MODULE = "./assets/palette-lzFbWMQk-C_UntwAA.js";
  const THREAD_MENU_MODULE = "./assets/thread-overflow-menu-1AqHdBKL.js";
  const AUTH_MODULE = "./assets/chatgpt-desktop-auth-url-CkOQTnB7.js";
  const SETTINGS_VISIBILITY_MODULE =
    "./assets/use-visible-settings-sections-Bd8lzZ2p.js";
  const TOOLBAR_BREADCRUMB_MODULE =
    "./assets/toolbar-breadcrumb-DHAxuM2B.js";
...
`;
  ...
  async function installNativeBinding() {
    ...
    appInitialModule.zHt();
    appInitialModule.Kjt();
    appInitialModule.tMt();
    appInitialModule.udt();
    appInitialModule.sOt();
    appInitialModule.HFt();
    appInitialModule.o6();
    appInitialModule.Dn();
    appInitialModule.xO();
    appInitialModule.DO();
    ...
    paletteIconModule.n();
    threadMenuModule.n();
    const jsxRuntime = appInitialModule.VHt();
    ...
    native = {
      React: appInitialModule.XHt(),
      ReactDOM: appInitialModule.pIt(),
      jsxRuntime,
      jsx: jsxRuntime.jsx,
      Item: appInitialModule.K0.Item,
      Separator: appInitialModule.K0.Separator,
      ...
      useUpdateAuthNonce: appInitialModule.wot,
      useAppServerRegistry: appInitialModule.Lot,
      useQueryClient: appInitialModule.BHt,
      accountInfoQueryKey: appInitialModule.Ujt,
      messageBus: appInitialModule.nMt,
      openInBrowser: appInitialModule.pdt,
      useNavigate: appInitialModule.hOt,
      useIntl: appInitialModule.tIt,
      useScope: appInitialModule.IVt,
      ApplicationScope: appInitialModule.VFt,
      ...
      SettingsRows: appInitialModule.bO,
      SettingsRow: appInitialModule.EO,
