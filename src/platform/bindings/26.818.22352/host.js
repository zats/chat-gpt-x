/**
 * Renderer binding for ChatGPT 26.818.22352.
 *
...
(() => {
  ...
  const APP_INITIAL_MODULE = "./assets/app-initial-2HRzhJVF.js";
  const PLUS_ICON_MODULE = "./assets/plus-BgCJgEEs-CxYr_sef.js";
  const PALETTE_ICON_MODULE = "./assets/palette-lzFbWMQk-9XeLyI_3.js";
  const THREAD_MENU_MODULE = "./assets/thread-overflow-menu-Dd6K_rDC.js";
  const AUTH_MODULE = "./assets/chatgpt-desktop-auth-url-P4mwHg2g.js";
  const SETTINGS_VISIBILITY_MODULE =
    "./assets/use-visible-settings-sections-Bh5p8z_9.js";
...
`;
  ...
  async function installNativeBinding() {
    ...
    appInitialModule.em();
    appInitialModule.cc();
    appInitialModule.Dot();
    appInitialModule.OHt();
    appInitialModule.Pot();
    appInitialModule.Fjt();
    appInitialModule.Wjt();
    appInitialModule.$ut();
    appInitialModule.eOt();
    appInitialModule.jFt();
    appInitialModule.wVt();
    appInitialModule.o6();
    appInitialModule.Dn();
    appInitialModule.DO();
    appInitialModule.NO();
    ...
    paletteIconModule.n();
    threadMenuModule.n();
    const jsxRuntime = appInitialModule.AHt();
    ...
    native = {
      React: appInitialModule.zHt(),
      ReactDOM: appInitialModule.nIt(),
      jsxRuntime,
      jsx: jsxRuntime.jsx,
      Item: appInitialModule.Q0.Item,
      Separator: appInitialModule.Q0.Separator,
      SubmenuItem: appInitialModule.Q0.SubmenuItem,
      FlyoutSubmenuItem: appInitialModule.Q0.FlyoutSubmenuItem,
      MenuRoot: appInitialModule.X0,
      ThreadMenuAdapter: appInitialModule.F1,
      ThreadMenu: threadMenuModule.t,
      ColorPicker: appInitialModule.sc,
      startChatGptSignIn: authModule.o,
      decorateAuthUrl: authModule.t,
      useUpdateAuthNonce: appInitialModule.Aot,
      useAppServerRegistry: appInitialModule.Lot,
      useQueryClient: appInitialModule.kHt,
      accountInfoQueryKey: appInitialModule.Mjt,
      messageBus: appInitialModule.Gjt,
      openInBrowser: appInitialModule.ndt,
      useNavigate: appInitialModule.iOt,
      useIntl: appInitialModule.WFt,
      useScope: appInitialModule.TVt,
      ApplicationScope: appInitialModule.AFt,
      ...
      SettingsToggle: appInitialModule.XW,
      SettingsSelectTrigger: appInitialModule.Yi,
      SettingsButton: appInitialModule.HF,
      settingsSectionIcons: settingsVisibilityModule.r,
      iconComponents: new Map([
        ["chevron-right", appInitialModule.m2],
        ["person", appInitialModule.$p],
        ["plus", PlusIcon],
        ["palette", paletteIconModule.t],
        ["settings", appInitialModule.a6],
      ]),
    };
    openNativeSettings = () => {
