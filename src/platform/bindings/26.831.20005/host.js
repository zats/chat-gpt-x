/**
 * Renderer binding for ChatGPT 26.831.20005.
 *
...
(() => {
  ...
  const APP_INITIAL_MODULE = "./assets/app-initial-592a0643ed17.js";
  const APP_PRIMARY_MODULE = "./assets/app-primary-a148c173c178.js";
  const PLUS_ICON_MODULE = "./assets/plus-BgCJgEEs-d32fd43fe4da.js";
  const PALETTE_ICON_MODULE = "./assets/palette-lzFbWMQk-a7a038ca2b89.js";
  const THREAD_MENU_MODULE = "./assets/thread-overflow-menu-feeae6fead4c.js";
  const AUTH_MODULE = "./assets/chatgpt-desktop-auth-url-23261482ffbc.js";
  const SETTINGS_VISIBILITY_MODULE =
    "./assets/use-visible-settings-sections-2654fd1f1a40.js";
  const SETTINGS_LOADING_MODULE =
    "./assets/settings-loading-row-6306803aa2e2.js";
  const TOOLBAR_BREADCRUMB_MODULE =
    "./assets/toolbar-breadcrumb-a144f2e69511.js";
  const CHEVRON_ICON_MODULE =
    "./assets/chevron-right-COkuMB7M-15d011565c65.js";
  const USER_ICON_MODULE = "./assets/user-DzSXx5EY-1e2cdf92acfc.js";
  const SETTINGS_ICON_MODULE = "./assets/settings-8KXOPtTT-ee844dc1f63a.js";
...
`;
  ...
  async function installNativeBinding() {
    ...
    authModule.i();
    authModule.r();
    appInitialModule.Oan();
    appInitialModule.Dan();
    appInitialModule.wan();
    appInitialModule.DU();
    appInitialModule.rS();
    appInitialModule.Jx();
    appInitialModule.Pu();
    ...
    const jsxRuntime = appInitialModule.Dan();
    ...
    native = {
      React: appInitialModule.Oan(),
      ReactDOM: appInitialModule.wan(),
      jsxRuntime,
      jsx: jsxRuntime.jsx,
      Item: appInitialModule.wU.Item,
      Separator: appInitialModule.wU.Separator,
      SubmenuItem: appInitialModule.wU.SubmenuItem,
      FlyoutSubmenuItem: appInitialModule.wU.FlyoutSubmenuItem,
      MenuRoot: appInitialModule.SU,
      SelectedTextOverlay: appPrimaryModule.po,
      SelectedTextPositioner: appPrimaryModule.ho,
      ThreadMenuAdapter: appInitialModule.bU,
      ThreadMenu: threadMenuModule.t,
      ColorPicker: appPrimaryModule.Kw,
      startChatGptSignIn: authModule.o,
      decorateAuthUrl: authModule.t,
      useAppServerRegistry: appInitialModule.Wpt,
      useQueryClient: appInitialModule.GYt,
      accountInfoQueryKey: appInitialModule.qRt,
      messageBus: appInitialModule.$Xt,
      openInBrowser: appInitialModule.JXt,
      useNavigate: appInitialModule.FHt,
      useIntl: appInitialModule.zin,
      useScope: appInitialModule.JYt,
      ApplicationScope: appInitialModule.WAt,
      SettingsPage: appInitialModule.tS,
      SettingsSectionTitle: appInitialModule.qx,
      ...
      SettingsToggle: appInitialModule.OU,
      SettingsSelectTrigger: appInitialModule.Gx,
      SettingsButton: appInitialModule.CTt,
      SettingsTextField: appInitialModule.$V,
