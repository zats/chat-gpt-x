/**
 * Renderer binding for ChatGPT 26.803.81509.
 *
...
(() => {
  ...
  const APP_INITIAL_MODULE = "./assets/app-initial-Bd3Z1bES.js";
  const PLUS_ICON_MODULE = "./assets/plus-BgCJgEEs-CUCwOF8J.js";
  const PALETTE_ICON_MODULE = "./assets/palette-lzFbWMQk-BwPZ6FZ9.js";
  const THREAD_MENU_MODULE = "./assets/thread-overflow-menu-BhIbhfkR.js";
  const AUTH_MODULE = "./assets/chatgpt-desktop-auth-url-NDLLumY2.js";
...
`;
  ...
  async function installNativeBinding() {
    ...
    authModule.r();
    appInitialModule.XU();
    appInitialModule.kht();
    appInitialModule.Nm();
    appInitialModule.yc();
    appInitialModule.I0();
    appInitialModule.mkt();
    appInitialModule.U0();
    appInitialModule.vxt();
    appInitialModule.rdt();
    appInitialModule.Zlt();
    plusIconModule.t();
    paletteIconModule.n();
    threadMenuModule.n();
    const jsxRuntime = appInitialModule.gkt();
    ...
    native = {
      React: appInitialModule.Ckt(),
      ReactDOM: appInitialModule.kCt(),
      jsxRuntime,
      jsx: jsxRuntime.jsx,
      ...
      useQueryClient: appInitialModule.hkt,
      accountInfoQueryKey: appInitialModule.lxt,
      messageBus: appInitialModule.yxt,
      openInBrowser: appInitialModule.odt,
      useNavigate: appInitialModule.aut,
      iconComponents: new Map([
        ["chevron-right", appInitialModule.Aht],
