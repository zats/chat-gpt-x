/**
 * Renderer binding for ChatGPT 26.825.31414.
 *
...
(() => {
  ...
  const APP_INITIAL_MODULE = "./assets/app-initial-CSDKmHwP.js";
  const PLUS_ICON_MODULE = "./assets/plus-BgCJgEEs-Crlkgyf4.js";
  const PALETTE_ICON_MODULE = "./assets/palette-lzFbWMQk-BdI-3IxE.js";
  const THREAD_MENU_MODULE = "./assets/thread-overflow-menu-B8jgkqkM.js";
  const AUTH_MODULE = "./assets/chatgpt-desktop-auth-url-9kGWb48_.js";
  const SETTINGS_VISIBILITY_MODULE =
    "./assets/use-visible-settings-sections-C5e5CFy0.js";
  const SETTINGS_LOADING_MODULE =
    "./assets/settings-loading-row-GA-afvrD.js";
  const TOOLBAR_BREADCRUMB_MODULE =
    "./assets/toolbar-breadcrumb-BZkvFwYX.js";
