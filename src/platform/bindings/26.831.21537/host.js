/**
 * Renderer binding for ChatGPT 26.831.21537.
 *
...
(() => {
  ...
  const APP_INITIAL_MODULE = "./assets/app-initial-b09f80199db1.js";
  const APP_PRIMARY_MODULE = "./assets/app-primary-699b5b6c9679.js";
  const PLUS_ICON_MODULE = "./assets/plus-BgCJgEEs-7542ebdc3d3c.js";
  const PALETTE_ICON_MODULE = "./assets/palette-lzFbWMQk-db06b886b5ff.js";
  const THREAD_MENU_MODULE = "./assets/thread-overflow-menu-8529b4bdfedd.js";
  const AUTH_MODULE = "./assets/chatgpt-desktop-auth-url-af877e3bdcd1.js";
  const SETTINGS_VISIBILITY_MODULE =
    "./assets/use-visible-settings-sections-f404b2dd3078.js";
  const SETTINGS_LOADING_MODULE =
    "./assets/settings-loading-row-410d807f8b06.js";
  const TOOLBAR_BREADCRUMB_MODULE =
    "./assets/toolbar-breadcrumb-fec340ffad70.js";
  const CHEVRON_ICON_MODULE =
    "./assets/chevron-right-COkuMB7M-80221dbead0b.js";
  const USER_ICON_MODULE = "./assets/user-DzSXx5EY-820599eff3d6.js";
  const SETTINGS_ICON_MODULE = "./assets/settings-8KXOPtTT-c34b85813569.js";
...
`;
  ...
  async function installNativeBinding() {
    ...
    authModule.i();
    authModule.r();
    appInitialModule.Ran();
    appInitialModule.Lan();
    appInitialModule.Pan();
    appInitialModule.DU();
    appInitialModule.lS();
    appInitialModule.eS();
    appInitialModule.Pu();
    ...
    const jsxRuntime = appInitialModule.Lan();
    ...
    native = {
      React: appInitialModule.Ran(),
      ReactDOM: appInitialModule.Pan(),
      jsxRuntime,
      jsx: jsxRuntime.jsx,
      Item: appInitialModule.AU.Item,
      Separator: appInitialModule.AU.Separator,
      SubmenuItem: appInitialModule.AU.SubmenuItem,
      FlyoutSubmenuItem: appInitialModule.AU.FlyoutSubmenuItem,
      MenuRoot: appInitialModule.OU,
      SelectedTextOverlay: appPrimaryModule.po,
      SelectedTextPositioner: appPrimaryModule.ho,
      ThreadMenuAdapter: appInitialModule.EU,
      ThreadMenu: threadMenuModule.t,
      ColorPicker: appPrimaryModule.Kw,
      startChatGptSignIn: authModule.o,
      decorateAuthUrl: authModule.t,
      useAppServerRegistry: appInitialModule.Qpt,
      useQueryClient: appInitialModule.tXt,
      accountInfoQueryKey: appInitialModule.rzt,
      messageBus: appInitialModule.lZt,
      openInBrowser: appInitialModule.iZt,
      useNavigate: appInitialModule.GHt,
      useIntl: appInitialModule.Yin,
      useScope: appInitialModule.iXt,
      ApplicationScope: appInitialModule.PYt,
      SettingsPage: appInitialModule.sS,
      SettingsSectionTitle: appInitialModule.$x,
      SettingsLoading: settingsLoadingModule.t,
      SettingsGroup: appInitialModule.Nu,
      SettingsRows: appInitialModule.Cu,
      SettingsRow: appInitialModule.ku,
      SettingsToggle: appInitialModule.PU,
      SettingsSelectTrigger: appInitialModule.Zx,
      SettingsButton: appInitialModule.MTt,
      SettingsTextField: appInitialModule.aH,
