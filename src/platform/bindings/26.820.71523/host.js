/**
 * Renderer binding for ChatGPT 26.820.71523.
 *
...
(() => {
  ...
  const APP_INITIAL_MODULE = "./assets/app-initial-CX2pZp2Q.js";
  const PLUS_ICON_MODULE = "./assets/plus-BgCJgEEs-Dme7XKRw.js";
  const PALETTE_ICON_MODULE = "./assets/palette-lzFbWMQk-rnpUtHUG.js";
  const THREAD_MENU_MODULE = "./assets/thread-overflow-menu-HBuyv2iM.js";
  const AUTH_MODULE = "./assets/chatgpt-desktop-auth-url-DL39kLsj.js";
  const SETTINGS_VISIBILITY_MODULE =
    "./assets/use-visible-settings-sections-DjXQMqVo.js";
  const SETTINGS_LOADING_MODULE =
    "./assets/settings-loading-row-Dslpkg74.js";
