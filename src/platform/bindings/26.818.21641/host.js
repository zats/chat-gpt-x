/**
 * Renderer binding for ChatGPT 26.818.21641.
 *
...
(() => {
  ...
  const APP_INITIAL_MODULE = "./assets/app-initial-DOX-K1rC.js";
  const PLUS_ICON_MODULE = "./assets/plus-BgCJgEEs-B85Jh4D_.js";
  const PALETTE_ICON_MODULE = "./assets/palette-lzFbWMQk-_AEtvi9I.js";
  const THREAD_MENU_MODULE = "./assets/thread-overflow-menu-DLgRC99N.js";
  const AUTH_MODULE = "./assets/chatgpt-desktop-auth-url-c5rz_oF2.js";
  const SETTINGS_VISIBILITY_MODULE =
    "./assets/use-visible-settings-sections-CTo7hdHM.js";
...
`;
  ...
  async function installNativeBinding() {
    ...
    appInitialModule.nm();
    appInitialModule.uc();
    appInitialModule.uot();
    appInitialModule.pHt();
    appInitialModule._ot();
    appInitialModule.bjt();
    appInitialModule.kjt();
    appInitialModule.Iut();
    appInitialModule.zDt();
    appInitialModule.gFt();
    appInitialModule.lVt();
    appInitialModule.U3();
    appInitialModule.Dn();
    appInitialModule.DO();
    appInitialModule.NO();
    ...
    paletteIconModule.n();
    threadMenuModule.n();
    const jsxRuntime = appInitialModule.hHt();
    ...
    native = {
      React: appInitialModule.wHt(),
      ReactDOM: appInitialModule.VFt(),
      jsxRuntime,
      jsx: jsxRuntime.jsx,
      Item: appInitialModule.F0.Item,
      Separator: appInitialModule.F0.Separator,
      SubmenuItem: appInitialModule.F0.SubmenuItem,
      FlyoutSubmenuItem: appInitialModule.F0.FlyoutSubmenuItem,
      MenuRoot: appInitialModule.N0,
      ThreadMenuAdapter: appInitialModule.v1,
      ThreadMenu: threadMenuModule.t,
      ColorPicker: appInitialModule.lc,
      startChatGptSignIn: authModule.o,
      decorateAuthUrl: authModule.t,
      useUpdateAuthNonce: appInitialModule.pot,
      useAppServerRegistry: appInitialModule.bot,
      useQueryClient: appInitialModule.mHt,
      accountInfoQueryKey: appInitialModule._jt,
      messageBus: appInitialModule.Ajt,
      openInBrowser: appInitialModule.zut,
      useNavigate: appInitialModule.UDt,
      useIntl: appInitialModule.kFt,
      useScope: appInitialModule.uVt,
      ApplicationScope: appInitialModule.hFt,
      SettingsPage: appInitialModule.ra,
      SettingsSectionTitle: appInitialModule.Zi,
      SettingsLoading: appInitialModule.ta,
      SettingsGroup: appInitialModule.En,
      SettingsRows: appInitialModule.EO,
      SettingsRow: appInitialModule.MO,
      SettingsToggle: appInitialModule.NW,
      SettingsSelectTrigger: appInitialModule.Yi,
      SettingsButton: appInitialModule.WF,
      settingsSectionIcons: settingsVisibilityModule.r,
      iconComponents: new Map([
        ["chevron-right", appInitialModule.Z0],
        ["person", appInitialModule.tm],
        ["plus", PlusIcon],
        ["palette", paletteIconModule.t],
        ["settings", appInitialModule.H3],
      ]),
    };
    openNativeSettings = () => {
