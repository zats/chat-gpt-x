 ...
 *
 * Usage: node src/platform/bindings/26.727.51351/ui-test.mjs [port]
...
async function validateUi(
  ...
  const appHeader = document.querySelector('header._Header_khftr_1');
  ...
  const headerToggle = (label) =>
    Array.from(
      document.querySelectorAll(
        `header._Header_khftr_1 button[aria-label="${label}"]`,
      ),
