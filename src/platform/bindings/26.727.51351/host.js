/**
 * Renderer binding for ChatGPT 26.727.51351.
 *
...
(() => {
  ...
  const APP_INITIAL_MODULE = "./assets/app-initial-iBPGfcXU.js";
  const PLUS_ICON_MODULE = "./assets/plus-BgCJgEEs-BMjGh1Kk.js";
  const PALETTE_ICON_MODULE = "./assets/palette-lzFbWMQk-BMVqIO8j.js";
  const THREAD_MENU_MODULE = "./assets/thread-overflow-menu-D0xHSoQA.js";
  const AUTH_MODULE = "./assets/chatgpt-desktop-auth-url-BtkHQc0r.js";
...
html[data-cgptx-header-background-color] header._Header_khftr_1 {
  background-color: transparent !important;
}
html[data-cgptx-header-background-color] header._Header_khftr_1 > div:nth-of-type(2),
html[data-cgptx-header-background-color] header._Header_khftr_1 > div:nth-of-type(3),
html[data-cgptx-header-background-color] header._Header_khftr_1 > div:nth-of-type(5) {
  background-color: var(--header-background-color) !important;
}
html[data-cgptx-header-background-color]:has(
    aside[data-app-shell-focus-area="right-panel"][style*="opacity: 1"]
  )
  header._Header_khftr_1 > div:nth-of-type(5) {
  background-color: transparent !important;
}
html[data-cgptx-header-background-color] header._Header_khftr_1 > div:nth-of-type(3) {
...
html[data-cgptx-header-foreground-color] header._Header_khftr_1 {
...
html[data-cgptx-header-background-color][data-cgptx-header-foreground-color]
  header._Header_khftr_1 button[class~="bg-token-bg-fog"] {
...
`;
  ...
  function ColorPickerSurface({ request }) {
    ...
    const headerBottom = document
      .querySelector("header._Header_khftr_1")
  ...
  async function installNativeBinding() {
    ...
    appInitialModule.Flt();
    appInitialModule.Qo();
    appInitialModule.t1();
    appInitialModule.CSt();
    appInitialModule.c1();
