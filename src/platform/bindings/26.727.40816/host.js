/**
 * Renderer binding for ChatGPT 26.727.40816.
 *
...
(() => {
  ...
  const APP_INITIAL_MODULE = "./assets/app-initial-DRyZ1Lin.js";
  const PLUS_ICON_MODULE = "./assets/plus-BgCJgEEs-BTOZTwQp.js";
  const PALETTE_ICON_MODULE = "./assets/palette-lzFbWMQk-CkXkwYIe.js";
  const THREAD_MENU_MODULE = "./assets/thread-overflow-menu-BiDSznNy.js";
  const AUTH_MODULE = "./assets/chatgpt-desktop-auth-url-Db47wv9W.js";
...
html[data-cgptx-header-background-color] header[data-app-shell-header-edge-scroll] {
  background-color: transparent !important;
}
html[data-cgptx-header-background-color] header[data-app-shell-header-edge-scroll] > div:nth-of-type(2),
html[data-cgptx-header-background-color] header[data-app-shell-header-edge-scroll] > div:nth-of-type(3),
html[data-cgptx-header-background-color] header[data-app-shell-header-edge-scroll] > div:nth-of-type(5) {
  background-color: var(--header-background-color) !important;
}
html[data-cgptx-header-background-color]:has(
    aside[data-app-shell-focus-area="right-panel"][style*="opacity: 1"]
  )
  header[data-app-shell-header-edge-scroll] > div:nth-of-type(5) {
  background-color: transparent !important;
}
html[data-cgptx-header-background-color] header[data-app-shell-header-edge-scroll] > div:nth-of-type(3) {
...
html[data-cgptx-header-foreground-color] header[data-app-shell-header-edge-scroll] {
...
html[data-cgptx-header-background-color][data-cgptx-header-foreground-color]
  header[data-app-shell-header-edge-scroll] button[class~="bg-token-bg-fog"] {
...
`;
  ...
  function openColorPicker(extId, options) {
    ...
    const headerBottom =
      document
        .querySelector("header[data-app-shell-header-edge-scroll]")
  ...
  async function installNativeBinding() {
    ...
    appInitialModule.dV();
    appInitialModule.uv();
    appInitialModule.kpt();
    appInitialModule.OH();
    appInitialModule.Qo();
    appInitialModule.t1();
    appInitialModule.Qmt();
    plusIconModule.t();
    paletteIconModule.n();
    threadMenuModule.n();
    const jsxRuntime = appInitialModule.TSt();
    ...
    native = {
      React: appInitialModule.jSt(),
      ReactDOM: appInitialModule.a_t(),
      jsxRuntime,
      jsx: jsxRuntime.jsx,
      Item: appInitialModule.cV,
      Separator: appInitialModule.uV,
      SubmenuItem: appInitialModule.oV,
      FlyoutSubmenuItem: appInitialModule.sV.FlyoutSubmenuItem,
      MenuRoot: appInitialModule.aV,
      ThreadMenu: threadMenuModule.t,
      ColorPicker: appInitialModule.Zo,
      startChatGptSignIn: authModule.o,
      decorateAuthUrl: authModule.t,
      useUpdateAuthNonce: appInitialModule.i1,
      useAppServerRegistry: appInitialModule.f1,
      useQueryClient: appInitialModule.wSt,
      accountInfoQueryKey: appInitialModule.Umt,
      messageBus: appInitialModule.$mt,
      openInBrowser: appInitialModule.art,
      useNavigate: appInitialModule.qet,
      iconComponents: new Map([
        ["chevron-right", appInitialModule.Opt],
        ["person", appInitialModule.lv],
        ["plus", PlusIcon],
