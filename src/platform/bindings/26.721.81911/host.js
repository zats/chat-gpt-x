/**
 * Renderer binding for ChatGPT 26.721.81911.
 *
...
(() => {
  ...
  const APP_INITIAL_MODULE = "./assets/app-initial-CRKqnyc3.js";
  const PLUS_ICON_MODULE = "./assets/plus-BgCJgEEs-NrefbuIG.js";
  const PALETTE_ICON_MODULE = "./assets/palette-lzFbWMQk-mZ4qEpdC.js";
  const THREAD_MENU_MODULE = "./assets/thread-overflow-menu-JO9PX18y.js";
  const AUTH_MODULE = "./assets/chatgpt-desktop-auth-url-0y3acVta.js";
