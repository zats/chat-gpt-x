/**
 * Renderer binding for ChatGPT 26.730.61639.
 *
...
(() => {
  ...
  const APP_INITIAL_MODULE = "./assets/app-initial-CKNQDTeE.js";
  const PLUS_ICON_MODULE = "./assets/plus-BgCJgEEs-DPgL_3TD.js";
  const PALETTE_ICON_MODULE = "./assets/palette-lzFbWMQk-DPnbv15j.js";
  const THREAD_MENU_MODULE = "./assets/thread-overflow-menu-BnGXLm0k.js";
  const AUTH_MODULE = "./assets/chatgpt-desktop-auth-url-Cfg4S9AH.js";
...
html[data-cgptx-header-background-color]
...
html[data-cgptx-header-foreground-color]
  header[data-app-shell-application-menu-bar] {
...
`;
  ...
  function ColorPickerSurface({ request }) {
    ...
    const headerBottom = document
      .querySelector("header[data-app-shell-application-menu-bar]")
  ...
  async function installNativeBinding() {
    ...
    authModule.r();
    appInitialModule.TCt();
    appInitialModule.yCt();
    appInitialModule.Z_t();
    appInitialModule.hH();
    appInitialModule.Fut();
    appInitialModule.Tv();
    appInitialModule.wf();
    appInitialModule.XQ();
    appInitialModule.r$();
    appInitialModule._Ct();
    appInitialModule.Iht();
    appInitialModule.Hht();
    appInitialModule.Bit();
    appInitialModule.Wrt();
    plusIconModule.t();
    paletteIconModule.n();
    threadMenuModule.n();
    const jsxRuntime = appInitialModule.yCt();
    ...
    native = {
      React: appInitialModule.TCt(),
      ReactDOM: appInitialModule.Z_t(),
      jsxRuntime,
      jsx: jsxRuntime.jsx,
      Item: appInitialModule.pH,
      Separator: appInitialModule.mH,
      SubmenuItem: appInitialModule.dH,
      FlyoutSubmenuItem: appInitialModule.fH.FlyoutSubmenuItem,
      MenuRoot: appInitialModule.uH,
      ThreadMenu: threadMenuModule.t,
      ColorPicker: appInitialModule.Cf,
      startChatGptSignIn: authModule.o,
      decorateAuthUrl: authModule.t,
      useUpdateAuthNonce: appInitialModule.$Q,
      useAppServerRegistry: appInitialModule.s$,
      useQueryClient: appInitialModule.vCt,
      accountInfoQueryKey: appInitialModule.Nht,
      messageBus: appInitialModule.Uht,
      openInBrowser: appInitialModule.Uit,
      useNavigate: appInitialModule.Jrt,
      iconComponents: new Map([
        ["chevron-right", appInitialModule.Put],
        ["person", appInitialModule.wv],
        ["plus", PlusIcon],
