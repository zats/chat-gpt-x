/**
 * Renderer binding for ChatGPT 26.818.41705.
 *
...
(() => {
  ...
  const APP_INITIAL_MODULE = "./assets/app-initial-CZAAElKi.js";
  const PLUS_ICON_MODULE = "./assets/plus-BgCJgEEs-CO-csf0i.js";
  const PALETTE_ICON_MODULE = "./assets/palette-lzFbWMQk-1HXKbe8r.js";
  const THREAD_MENU_MODULE = "./assets/thread-overflow-menu-UM2bgC7U.js";
  const AUTH_MODULE = "./assets/chatgpt-desktop-auth-url-vFV3kYCn.js";
  const SETTINGS_VISIBILITY_MODULE =
    "./assets/use-visible-settings-sections-D6GQiEZo.js";
